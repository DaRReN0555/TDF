import { BufferUsage, CanvasSource, DOMAdapter, ExtensionType, Geometry, GlProgram, Matrix, Rectangle, RendererType, STENCIL_MODES, Shader, State, Texture, TextureSource, UniformGroup, checkMaxIfStatementsInShader, colorBitGl, compileHighShaderGlProgram, extensions, generateTextureBatchBitGl, getAttributeInfoFromFormat, getBatchSamplersUniformGroup, localUniformBitGl, roundPixelsBitGl, warn } from "./colorToUniform-CUTLKdLN.js";
import { AbstractRenderer, BufferResource, CLEAR, GpuStencilModesToPixi, RenderTargetSystem, SharedRenderPipes, SharedSystems, UboSystem, createUboSyncFunction, ensureAttributes, textureBitGl, uboSyncFunctionsSTD40, uniformParsers } from "./SharedSystems-hjSX02JQ.js";
...
var _GlContextSystem = class _GlContextSystem$1 {
	...
	*/
	...
	init(options) {
		options = {
			..._GlContextSystem$1.defaultOptions,
			...options
		};
	...
	*/
	validateContext(gl) {
		...
		const extensions$1 = this.extensions;
		supports.uint32Indices = isWebGl2 || !!extensions$1.uint32ElementIndex;
		supports.uniformBufferObject = isWebGl2;
		supports.vertexArrayObject = isWebGl2 || !!extensions$1.vertexArrayObject;
		supports.srgbTextures = isWebGl2 || !!extensions$1.srgb;
...
var _GlBackBufferSystem = class _GlBackBufferSystem$1 {
	constructor(renderer) {
	...
	init(options = {}) {
		const { useBackBuffer, antialias } = {
			..._GlBackBufferSystem$1.defaultOptions,
			...options
		};
...
var GlRenderTargetAdaptor = class {
	...
	_initColor(renderTarget, glRenderTarget) {
		...
		renderTarget.colorTextures.forEach((colorTexture, i) => {
			...
			gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0 + i, 3553, glTexture, 0);
		});
...
var WINDING = 4;
var DEPTH_MASK = 5;
var _GlStateSystem = class _GlStateSystem$1 {
	constructor(renderer) {
		/**
	...
	*/
	setBlend(value) {
		this._updateCheck(_GlStateSystem$1._checkBlendMode, value);
	...
	*/
	setOffset(value) {
		this._updateCheck(_GlStateSystem$1._checkPolygonOffset, value);
...
function mapFormatToGlInternalFormat(gl, extensions$1) {
	let srgb = {};
	...
	if (!(gl instanceof DOMAdapter.get().getWebGLRenderingContext())) {
		...
		bgra8unorm = gl.RGBA8;
	} else if (extensions$1.srgb) srgb = {
		"rgba8unorm-srgb": extensions$1.srgb.SRGB8_ALPHA8_EXT,
		"bgra8unorm-srgb": extensions$1.srgb.SRGB8_ALPHA8_EXT
	};
	return {
		r8unorm: gl.R8,
		r8snorm: gl.R8_SNORM,
		...
		...extensions$1.s3tc ? {
			"bc1-rgba-unorm": extensions$1.s3tc.COMPRESSED_RGBA_S3TC_DXT1_EXT,
			"bc2-rgba-unorm": extensions$1.s3tc.COMPRESSED_RGBA_S3TC_DXT3_EXT,
			"bc3-rgba-unorm": extensions$1.s3tc.COMPRESSED_RGBA_S3TC_DXT5_EXT
		} : {},
		...extensions$1.s3tc_sRGB ? {
			"bc1-rgba-unorm-srgb": extensions$1.s3tc_sRGB.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT,
			"bc2-rgba-unorm-srgb": extensions$1.s3tc_sRGB.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT,
			"bc3-rgba-unorm-srgb": extensions$1.s3tc_sRGB.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT
		} : {},
		...extensions$1.rgtc ? {
			"bc4-r-unorm": extensions$1.rgtc.COMPRESSED_RED_RGTC1_EXT,
			"bc4-r-snorm": extensions$1.rgtc.COMPRESSED_SIGNED_RED_RGTC1_EXT,
			"bc5-rg-unorm": extensions$1.rgtc.COMPRESSED_RED_GREEN_RGTC2_EXT,
			"bc5-rg-snorm": extensions$1.rgtc.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT
		} : {},
		...extensions$1.bptc ? {
			"bc6h-rgb-float": extensions$1.bptc.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT,
			"bc6h-rgb-ufloat": extensions$1.bptc.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT,
			"bc7-rgba-unorm": extensions$1.bptc.COMPRESSED_RGBA_BPTC_UNORM_EXT,
			"bc7-rgba-unorm-srgb": extensions$1.bptc.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT
		} : {},
		...extensions$1.etc ? {
			"etc2-rgb8unorm": extensions$1.etc.COMPRESSED_RGB8_ETC2,
			"etc2-rgb8unorm-srgb": extensions$1.etc.COMPRESSED_SRGB8_ETC2,
			"etc2-rgb8a1unorm": extensions$1.etc.COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2,
			"etc2-rgb8a1unorm-srgb": extensions$1.etc.COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2,
			"etc2-rgba8unorm": extensions$1.etc.COMPRESSED_RGBA8_ETC2_EAC,
			"etc2-rgba8unorm-srgb": extensions$1.etc.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC,
			"eac-r11unorm": extensions$1.etc.COMPRESSED_R11_EAC,
			"eac-rg11unorm": extensions$1.etc.COMPRESSED_SIGNED_RG11_EAC
		} : {},
		...extensions$1.astc ? {
			"astc-4x4-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_4x4_KHR,
			"astc-4x4-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR,
			"astc-5x4-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_5x4_KHR,
			"astc-5x4-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR,
			"astc-5x5-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_5x5_KHR,
			"astc-5x5-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR,
			"astc-6x5-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_6x5_KHR,
			"astc-6x5-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR,
			"astc-6x6-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_6x6_KHR,
			"astc-6x6-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR,
			"astc-8x5-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_8x5_KHR,
			"astc-8x5-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR,
			"astc-8x6-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_8x6_KHR,
			"astc-8x6-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR,
			"astc-8x8-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_8x8_KHR,
			"astc-8x8-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR,
			"astc-10x5-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_10x5_KHR,
			"astc-10x5-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR,
			"astc-10x6-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_10x6_KHR,
			"astc-10x6-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR,
			"astc-10x8-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_10x8_KHR,
			"astc-10x8-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR,
			"astc-10x10-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_10x10_KHR,
			"astc-10x10-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR,
			"astc-12x10-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_12x10_KHR,
			"astc-12x10-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR,
			"astc-12x12-unorm": extensions$1.astc.COMPRESSED_RGBA_ASTC_12x12_KHR,
			"astc-12x12-unorm-srgb": extensions$1.astc.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR
		} : {}
	};
}
...
var GlTextureSystem = class {
	...
	*/
	...
	updateStyle(source, firstCreation) {
		...
		applyStyleParams(source.style, gl, source.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", gl.TEXTURE_2D, !this._renderer.context.supports.nonPowOf2wrapping && !source.isPowerOfTwo, firstCreation);
	}
