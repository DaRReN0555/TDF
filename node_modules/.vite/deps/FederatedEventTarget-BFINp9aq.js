import { ExtensionType, Point, Ticker, UPDATE_PRIORITY, ViewContainer, eventemitter3_default, removeItems, warn } from "./colorToUniform-CUTLKdLN.js";
...
var isAppleTabletOnIos13 = function(navigator$1) {
	return typeof navigator$1 !== "undefined" && navigator$1.platform === "MacIntel" && typeof navigator$1.maxTouchPoints === "number" && navigator$1.maxTouchPoints > 1 && typeof MSStream === "undefined";
};
...
var _AccessibilitySystem = class _AccessibilitySystem$1 {
	/**
	...
	*/
	init(options) {
		const mergedOptions = { accessibilityOptions: {
			..._AccessibilitySystem$1.defaultOptions,
...
var _EventSystem = class _EventSystem$1 {
	/**
	...
	*/
	constructor(renderer) {
		...
		*/
		...
		this.features = new Proxy({ ..._EventSystem$1.defaultEventFeatures }, { set: (target, key, value) => {
	...
	*/
	init(options) {
		...
		_EventSystem$1._defaultEventMode = options.eventMode ?? "passive";
...
//#endregion
export { AccessibilitySystem, CanvasObserver, DOMContainer, DOMPipe, EventBoundary, EventSystem, EventsTicker, FederatedContainer, FederatedEvent, FederatedMouseEvent, FederatedPointerEvent, FederatedWheelEvent, accessibilityTarget, isMobile };
//# sourceMappingURL=FederatedEventTarget-BFINp9aq.js.map